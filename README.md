...
Office Claw AI is a flavor of the [EverClaw](https://everclaw.xyz) decentralized AI agent ecosystem, powered by Morpheus Network inference.
...
```bash
curl -sSL https://officeclaw.ai/install.sh | bash
```
